...
7. ZeRO offers 3 optimization stages
   - ZeRO stage 1: shards only optimizer states across GPUs, which can reduce your memory footprint by up to a factor of four.
   ...
   - ZeRO stage 3: shards all components including the model parameters across GPUs. When applied together with stage 1 and 2, memory reduction is linear with a number of GPUs. ex: sharding across 64 GPUs could reduce your memory by a factor of 64
...
![image](https://github.com/FionaYuY/Generative-AI-with-Large-Language-Models_notes/blob/999deca81c1fbea1742984a7012f17f13b48c9c2/screenshots%20of%20lecture%20slides/0135.jpg)
